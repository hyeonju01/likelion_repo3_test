...
public class CurrencyCnt {
    public static void main(String[] args) {
        ...
        temp = temp % 100;
        System.out.println("100원권 몫: " + cnt_100 + "개");
        System.out.println("100원권 나머지: " + temp + "개");

        int cnt_50 = temp / 50;
        temp = temp % 50;
        System.out.println("50원권 몫: " + cnt_50 + "개");
        System.out.println("50원권 나머지: " + temp + "개");

        int cnt_10 = temp / 10;
        temp= temp % 10;
        System.out.println("10원권 몫: " + cnt_10 + "개");
